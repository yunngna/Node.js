...
<template>
    ...
    <table>
        <tbody>
            ...
            :key="commentInfo.no" >
            <td class="text-right">{{ commentInfo.writer }} | </td>
            <td class="test-right">{{ commentInfo.content }} |</td>
            <td class="test-right">{{dateFormet(commentInfo.created_date,'yyyy-MM-dd')}}</td>
        </tr>
        </tbody>
    </table>
</template>
